...
def uploadFile():
    if request.method == 'POST':
        ...
        return render_template("index.html", message=text.text)
...
def getRecomended():
    if request.method == 'GET':
        ...
        text = requests.get("http://127.0.0.1:8080/Nuno19/Recomendation_Service/1.0.0/getRecommended",{"centID":centID})
